import { SmallButton, SmallButtonWhite } from ".";


function StaffDependantForm() {
    return (
        <form className="h-full overflow-y-hidden">
            <div className="w-full bg-white p-[16px] border border-[#DFE2E9] rounded-[10px] mb-5 overflow-y-scroll h-[90%]">
                ...
                <div className="flex justify-end">
                    <SmallButtonWhite text="Add dependant" />
                </div>
            </div>

            <div className="flex justify-end">
                <SmallButton text="Submit information" disabled={true} />
            </div>
        </form>
    );
}

export default StaffDependantForm;