import { AccountForm, AddOrganizationModal, Dependant, EditEnrolleeModal, EnrolleeInfo, InsuranceSettingForm, InsurerRow, Nav, OrganizationRow, OrganizationUserRow, ProviderRow, SmallButton, SmallButtonWhite, SmatNav, StaffRow, UploadProviderModal } from "@/components";
...
;    return (
        <>
            <main className="bg-[#EDF0F8] h-screen overflow-hidden">
                <UploadProviderModal visible={openModal} closeModal={() => setOpenModel(false)} />
                <SmatNav name="Yemisi" />
                <section className="p-[32px]">
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <SmallButton text="Upload providers" onClick={() => setOpenModel(true)} />
                    </div>

                    <div className="flex justify-between items-center mb-5">
                        <div className="flex">
                            <span className="text-[#051438] text-[16px] font-semibold">Providers</span>
                        </div>
