import { AddConditionModal, PreExistingConditionRow, SmallButton, SmatNav } from "@/components";
...
function PreExistingCondition() {
    const [openModal, setOpenModel] = useState(false);

;    return (
        <>
            <main className="bg-[#EDF0F8]">
                <AddConditionModal visible={openModal} closeModal={() => setOpenModel(false)} />
                <SmatNav name="Yemisi" />
                <section className="p-[32px]">
                    <div className="flex justify-between items-center mb-8">
                        ...
                        <SmallButton text="Add condition" onClick={() => setOpenModel(true)} />
                    </div>

                    <div className="flex justify-between items-center mb-5">
                        <div className="flex">
                            <span className="text-[#051438] text-[16px] font-semibold">Pre-existing conditions</span>
                        </div>
